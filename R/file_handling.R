...
# Add DEG set to table of added DEG sets
...
# Add enrichment result to table of uploaded enrichment results
# file: Whether rr to append comes from a file or from richStudio enrichment
...
# Add cluster result to list of created cluster results
